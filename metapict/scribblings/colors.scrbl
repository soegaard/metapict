...
@deftogether[(@defproc*[([(color [c color%] [p pict?]) pict?]
                         [(color [f real?] [c color%] [p pict?]) pict?])])
...
@defproc[(color+ [c1 color] [c2 color]) color%]{
...
@defproc[(color* [k real?] [c color]) color%]{
Returns a @racket[color%] objects, whose color components are the 
...
@defproc[(color-med [t real?] [c1 color] [c2 color]) color%]{
...
@defproc[(color-med* [t real?] [cs (listof color)]) color%]{
...
@deftogether[( @defproc[(change-red   [c color] [r real]) color%]
               @defproc[(change-blue  [c color] [r real]) color%]
               @defproc[(change-green [c color] [r real]) color%]
               @defproc[(change-alpha [c color] [r real]) color%])]{
