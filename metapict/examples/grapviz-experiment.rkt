...
;;;
;;; Drawing graphs with layouts done by Grapviz
;;;

; This file demonstrates how graphs can be drawn by using layouts
; from Graphviz.

; The graph package can produce input that Graphviz understands.
; Grapviz can then layout the graph and store the information as json.

; The details of how the information is stored in the json file
; are found here:
